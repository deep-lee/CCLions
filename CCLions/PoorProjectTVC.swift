...
class PoorProjectTVC: UITableViewController, IndicatorInfoProvider {
    
    var itemInfo = IndicatorInfo(title: "View")
    var model: PoorProjectModel!
    ...
    func initView() -> Void {
        model = PoorProjectModel.shareInstance()
        initNotification()
    ...
    func initNotification() -> Void {
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(PoorProjectTVC.refreshDataSuccessNoti(_:)), name: POOR_PROJECT_REFRESH_DATA_SUCCESS, object: nil)
