...
class MyRecordVC: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllersForPagerTabStrip(pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let child_1 = WithdrawRecordTVC(style: .Plain, itemInfo: "提款记录")
...
extension MyRecordVC: CommonFlowViewDelegate {
