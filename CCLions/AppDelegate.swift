		...
		ShareSDK.registerApp(SHARE_SDK_APP_KEY,
			...
			onConfiguration: { (platform: SSDKPlatformType, appInfo: NSMutableDictionary!) -> Void in
				...
				case SSDKPlatformType.TypeSinaWeibo:
					...
					appInfo.SSDKSetupSinaWeiboByAppKey("1399359717",
						appSecret: "c4d6f2df67b96c3d18ff27cdc12298ee",
				...
				case SSDKPlatformType.TypeWechat:
					// 设置微信应用信息
					appInfo.SSDKSetupWeChatByAppId("wx91ab3e743811fe3b", appSecret: "b726a691dde793cd7166d92c6f0aa1cb")
					break
				default:
					break
