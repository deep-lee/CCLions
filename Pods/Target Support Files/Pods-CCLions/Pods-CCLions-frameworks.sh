...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-CCLions/MJRefresh.framework"
  install_framework "Pods-CCLions/NSObject_SafeExpectations.framework"
  install_framework "Pods-CCLions/SDCycleScrollView.framework"
